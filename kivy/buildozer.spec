...
android.permissions = android.permission.READ_EXTERNAL_STORAGE, android.permission.READ_MEDIA_AUDIO, (name=android.permission.WRITE_EXTERNAL_STORAGE;maxSdkVersion=29)
...
# use that parameter https://developer.android.com/tools/releases/platformstogether with android.entrypoint to set custom Java class instead of PythonActivity
...
#android.add_libs_armeabi = libdl
#android.add_libs_armeabi_v7a = libs/android-v7/*.so
#android.add_libs_arm64_v8a = libdl
